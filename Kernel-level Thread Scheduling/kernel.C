...
/* This macro is defined when we want to use the Round-Robin Scheduler.
   Otherwise, the FIFO scheduler is used.
*/
...
/* -- GLOBAL VARIABLES FOR SCHEDULER CONFIGURATION */

bool USE_RR_SCHEDULER = 
...
int main()
{
    ...
    // Choosing the timer based on RR or FIFO scheduler
    #ifdef _RR_SCHEDULER_
    EOQTimer timer(1000, 5); /* timer ticks every 10ms, time quantum is 50ms */
    #else
